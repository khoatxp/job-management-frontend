                                        ...
                                        <div>
                                            ...
                                            <Button
                                                ...
                                                onClick={async () => {
                                                    ...
                                                    const response = await fetch('https://user-profile-service-pvwu2w75ta-wl.a.run.app/user/profilepicture', requestOptions)
                                                    const json = await response.json();
                                                    const profileUrl = json.url;

                                                    await changeProfileUrlMutation({
                                                        variables: {
                                                            userId,
                                                            profileUrl
                                                        }
                                ...
                                <Card.Content>
                                    ...
                                    <Card.Description>
                                        <div className="form-container">
                                            <Form onSubmit={changeProfile} noValidate
